...
export default function (){
  return (
    ...
    <img className='perfil' src="https://instagram.frec7-1.fna.fbcdn.net/v/t51.2885-19/s150x150/39915906_399189717281759_4127910832170336256_n.jpg?_nc_ht=instagram.frec7-1.fna.fbcdn.net&_nc_ohc=sQ6yIHqIwlEAX_gQqla&oh=104cdb12be2e00871874014fe5eecfd7&oe=5FA15B19" alt=""/>
    <ul className='redes'>
      <div className='div-redes'>
            <p className='p-ul'>Contato</p>
          <ul className='div-redes-ul'>
                    <li><p className='waths'><a className='link-href' href="https://wa.me/5581986384447?text=Ol%C3%A1+gostaria+da+saber+um+pouco+do+seu+trabalho%21"> <img className='img-link' src={WathsappImg} alt=""/></a></p></li>
        <li><p className='insta'><a className='link-href' href='https://www.instagram.com/matheus_lisbon/'> <img className='img-link' src={Instagram} alt=""/></a></p></li>
        <li><p className='face'><a className='link-href' href="https://www.facebook.com/profile.php?id=100009610324999"> <img className='img-link' src={Facebook} alt=""/></a> </p></li>
        <li><p className='linkedin'><a className='link-href' href="https://www.linkedin.com/in/matheus-eduardo-a83a8a1a7/"> <img className='img-link' src={Linkedin} alt=""/></a></p></li>
      ...
      <div div-tec>
        <p className='p-ul'>Tecnologias</p>
          ...
          <li><img className='img-tech' src={ReactImg} alt=""/></li>
          <li><img className='img-tech' src={postgresImg} alt=""/></li> 
          <li><img className='img-tech' src={SequelizeImg} alt=""/></li>
          <li><img className='img-tech' src={JavascriptImg} alt=""/></li>
          <li><img className='img-tech' src={JestImg} alt=""/></li>
          <li><img className='img-tech' src={NodeImg} alt=""/></li>
          <li><img className='img-tech' src={mongoImg} alt=""/></li>
          <li><img className='img-tech' src={mySqlImg} alt=""/></li>
